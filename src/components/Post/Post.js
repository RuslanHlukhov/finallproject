    ...
    return (
        <div className="post">
            <div className="container">
                ...
                {isLogin ?
                    <Card >
                        <Card.Header>Категория : {category} | {name}</Card.Header>
                        <Card.Body>
                            <Card.Title>{title}</Card.Title>
                            <Card.Text className="textoneline">
                                {text}
                            </Card.Text>
                            <Col>
                ...
                >
                    ...
                    <Modal.Header closeButton>
                        <Row>
                            <h4 className="category">Категория : {category} | Автор : {name}</h4>
                        </Row>
                    </Modal.Header>
                    <h5 className="title" type="text">{title}</h5>
                    <Row><Modal.Title id="example-custom-modal-styling-title" >
                    </Modal.Title>
                    </Row>
                    <Card.Img className="photo" variant="top" src={image} />
                    <Modal.Body className="textPost"><p>{text}</p></Modal.Body>
                    <Modal.Footer>
                ...
                >
                    ...
                    />
                    <Col>
                    <Button className="updatePost" variant="primary" onClick={update}>Изменить</Button>
                    </Col>
                </Modal>
